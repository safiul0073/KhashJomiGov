        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom-info d-flex">
                    <a href="{{url('/admin/adc_revinew')}}" class="btn btn-sm btn-primary">পূর্বের পেজ</a>
            ...
            <form action="{{route('adc_revinew.to.acland', $application->id)}}" enctype="multipart/form-data" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
