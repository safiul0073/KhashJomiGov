    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <a href="{{url('/admin/adc_revinew?tab=apps')}}" class="btn @if($tab == "apps" || $tab == null) btn-success @else btn-primary @endif">আবেদনকৃত ({{$applications_count}})</a>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                         ...
                         @if ($tab == 'apps')
                            @include('admin.contents.adc_revinew.all-apps-table')
                         @else
